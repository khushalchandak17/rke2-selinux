...
restorecon -RU -T 0 -i /etc/systemd/system/rke2*; \
restorecon -RU -T 0 -i /usr/local/lib/systemd/system/rke2*; \
restorecon -RU -T 0 -i /usr/lib/systemd/system/rke2*; \
restorecon -RU -T 0 /var/lib/cni; \
restorecon -RU -T 0 /opt/cni; \
restorecon -RU -T 0 /etc/cni; \
restorecon -RU -T 0 /var/lib/kubelet; \
restorecon -RU -T 0 /var/lib/rancher/rke2; \
restorecon -RU -T 0 /var/run/k3s; \
restorecon -RU -T 0 /var/run/flannel
